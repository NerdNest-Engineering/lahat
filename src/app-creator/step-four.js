...
class AppCreationStepFour extends HTMLElement {
  constructor() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <div>
        ...
        <div class="credential-warning" id="credential-warning">
    ...
    this.shadowRoot.querySelector('#setup-claude-btn').addEventListener('click', this.handleSetupCredentials.bind(this));
  ...
  setActive(active) {
    if (active) {
      ...
      // Don't auto-start generation - let controller handle credential check first
    } else {
  ...
  showCredentialMissingUI() {
    ...
    this.shadowRoot.querySelector('.generation-section').style.display = 'none';
    
    // Show credential warning
    this.shadowRoot.querySelector('#credential-warning').style.display = 'block';
    
    console.log('Step Four: Credential missing UI shown');
  }
  ...
  hideCredentialMissingUI() {
    ...
    this.shadowRoot.querySelector('.generation-section').style.display = 'block';
    
    console.log('Step Four: Credential missing UI hidden');
  }
  ...
  async handleRetryGeneration() {
    ...
    if (controller) {
      await controller.checkClaudeCredentialsAndGenerateApp();
    }
  }
  
  async handleSetupCredentials() {
    try {
